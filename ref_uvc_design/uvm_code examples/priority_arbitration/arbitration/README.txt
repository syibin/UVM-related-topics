This example shows how the different arbitration mechanisms work. The example
contains a number of sequences which are competing to send sequence_items to
a driver. These sequences have different priorities. The arbitration argument
used by the sequencer is set via a command line plusarg switch:
