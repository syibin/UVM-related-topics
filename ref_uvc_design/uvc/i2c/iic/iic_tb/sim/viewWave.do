...
add wave -noupdate -divider SCBD
add wave -noupdate -label m_resetMaster2Scb /uvm_root/uvm_test_top/m_env/m_iic_scoreboard/m_resetMaster2Scb
add wave -noupdate -label m_resetMaster1Scb /uvm_root/uvm_test_top/m_env/m_iic_scoreboard/m_resetMaster1Scb
add wave -noupdate -label m_master1ScbState /uvm_root/uvm_test_top/m_env/m_iic_scoreboard/m_master1ScbState
add wave -noupdate -label m_master2ScbState /uvm_root/uvm_test_top/m_env/m_iic_scoreboard/m_master2ScbState
add wave -noupdate -divider <NULL>
...
update
WaveRestoreZoom {87250122 ns} {87254778 ns}
